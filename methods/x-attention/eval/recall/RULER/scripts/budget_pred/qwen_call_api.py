...
import traceback
from xattn.src.budget_load_qwen_recall import FastPrefillConfig
...
def get_llm(tokens_to_generate):
  if args.server_type == 'trtllm':
    ...
    from qwen_model_wrappers import HuggingFaceModel
    ...
    from qwen_model_wrappers import MambaModel
    llm = MambaModel(
      name_or_path=args.model_name_or_path,
      repetition_penalty=1,
      temperature=args.temperature,
