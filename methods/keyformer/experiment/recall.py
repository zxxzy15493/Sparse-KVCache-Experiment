...
from keyformer_kv.keyformer_recall import enable_keyformer_recall, stats_registry, init_new_sample_registry
...
def build_output_path(model_name_or_path, dataset_name, args, dataset_path=None):
    ...
    budget = args.recent_size + args.key_size
...
def main(args):
    ...
    enable_keyformer_recall(model, args)
