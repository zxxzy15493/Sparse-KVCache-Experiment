...
__all__ = ["enable_glm_pos_shift_attention"]
...
def glm_pos_shift_attention_forward(
    ...
    if not hasattr(self, "kv_cache_evictor"):
        ...
        self.kv_cache_evictor = KeyformerKVCache(
    ...
    if q_len > 1:
        self.itr_count = 0
        self.absolute_full_k = None
        step_layer_recalls["_global_step"] = 0
    ...
    key_states_compress, value_states_compress = self.kv_cache_evictor.evict_for_space(query_layer, key_layer, value_layer, getattr(self, "itr_count", 0))
    ...
    if q_len == 1:
        self.itr_count = getattr(self, "itr_count", 0) + 1
