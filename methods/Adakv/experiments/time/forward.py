"""
Timed DecoderLayer forward (HeadKV).

Replaces decoder layer forward with timing markers.
The attention forward generates its own internal timing for
qkv_proj / o_proj / write_cache via _timing_events dict.
"""
