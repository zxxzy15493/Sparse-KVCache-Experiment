"""
Unified CUDA Event TimeManager for 12-component measurement (HeadKV).
...
class TimeManager:
    ...
    def _alloc_events(self):
        ...
        # dummy-record all events so elapsed_time() never fails even on
        # code paths that don't touch certain events
    ...
    # ── properties for _timing_events dict ──
    @property
    ...
    def finish_round(self):
        ...
        for l in range(L):
            ...
            # rope/expand/reshape = total_attn - pure - qkv_proj - o_proj - pattern - idx - write_cache
