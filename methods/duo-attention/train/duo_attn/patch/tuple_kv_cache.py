...
# From Huggingface's Transformers v4.34.0. This is the forward method of Qwen2ForCausalLM using the tuple style KV cache.
def old_qwen2_for_causal_lm_forward(
    self,
    input_ids: torch.LongTensor = None,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
# From Huggingface's Transformers v4.34.0. This is the forward method of Qwen2Model using the tuple style KV cache.
...
# From Huggingface's Transformers v4.34.0. This is the forward method of Qwen2DecoderLayer using the tuple style KV cache.
...
def enable_tuple_kv_cache_for_qwen2(model: Qwen2ForCausalLM):
    # print("Enabling tuple KV cache for Qwen2 (using Llama functions)")
    # model.model._prepare_decoder_attention_mask = lambda *args, **kwargs: None
    # model.model.forward = types.MethodType(old_llama_model_forward, model.model)  # Usage Llama version
    # for idx in range(len(model.model.layers)):
    #     model.model.layers[idx].forward = types.MethodType(
    #         old_llama_decoder_layer_forward, model.model.layers[idx]  # Usage Llama version
    #     )
    #     model.model.layers[idx].self_attn.forward = types.MethodType(
    #         old_flash_attention_2_forward, model.model.layers[idx].self_attn
    #     )
    ...
    #         _flash_attention_forward, model.model.layers[idx].self_attn
    #     )
    # model.forward = types.MethodType(old_llama_for_causal_lm_forward, model)  # Usage Llama version
...
def old_mistral_for_causal_lm_forward(
    self,
    input_ids: torch.LongTensor = None,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
# From Huggingface's Transformers v4.34.0. This is the forward method of MistralModel using the tuple style KV cache.
def old_mistral_model_forward(
    self,
    input_ids: torch.LongTensor = None,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
# From Huggingface's Transformers v4.34.0. This is the forward method of MistralDecoderLayer using the tuple style KV cache.
def old_mistral_decoder_layer_forward(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
