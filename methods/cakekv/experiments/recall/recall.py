...
from cake_recall import enable_cake_recall, stats_registry, init_new_sample_registry
...
def parse_args(args=None):
    ...
    parser.add_argument('--dataset', type=str, default="", help="The folder of dataset to evaluate on")
...
def get_pred_single_gpu(data, max_length, max_gen, prompt_format, dataset, dataset_name, model_name, model2path, output_path, compress_args=None):
    ...
    if compress_args is not None:
        enable_cake_recall(model, check_recall=True, **compress_args)
...
if __name__ == '__main__':
    ...
    output_path = build_output_path(model_name, dataset_name, dataset_path, compress_args, task=task)
