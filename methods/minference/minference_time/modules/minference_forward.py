...
from .pit_sparse_flash_attention_v2 import vertical_slash_sparse_attention
...
def minference_prefill_kernel(
    ...
    def vertical_and_slash_kernel(q, k, v, vertical_size, slash_size):
        ...
        time_manager.pattern_allocation_start_event_head[layer_idx*32 + head_id].record()
        ...
        time_manager.pattern_allocation_end_event_head[layer_idx*32 + head_id].record()
        

        # ============================================================

        # time_manager.prefill_attn_start_event_head[layer_idx*32 + head_id].record()

        attn_output = vertical_slash_sparse_attention(q, k, v, vertical_topk, slash)
        
        # time_manager.prefill_attn_end_event_head[layer_idx*32 + head_id].record()
