...
def vertical_slash_sparse_attention(
    ...
    if RECALL:
        ...
        del topK_s, hit_v, hit_s, recall_token_n  # 释放内存


        # 6. 向量化计算 Weight Recall
        # 构建 [N, context_size] 的偏移量匹配矩阵
        ...
        # 合并命中条件: 列索引在 v_idx 中，或者 (line - 列索引) 在 s_idx 中
