...
from model_hub import LlamaModel, QwenModel, GlmModel, timeManager
...
def get_pred(llm, data, max_new_tokens, model_name, out_path, args):
        ...
        out_path = Path(out_path) / f"SelectTimeBreakdown_{args.input_max_token}_{args.fixed_output_length}_{args.budget}.json"
        pred = output[0]


        time_breakdown = timeManager.get_final_time()
...
if __name__ == '__main__':
    ...
    if "llama" in model_name.lower() :
        timeManager.myinit(args.fixed_output_length, 32)
    elif "qwen" in model_name.lower() :
        timeManager.myinit(args.fixed_output_length, 28)
