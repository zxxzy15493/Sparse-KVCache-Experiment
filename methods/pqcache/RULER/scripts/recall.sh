...
# bash run.sh MODEL_NAME BENCHMARK_NAME SYNTHETIC_TASKS PQ_BUDGET
# Example:
#   bash run.sh qwen-2.5-7b-1m synthetic niah_single_1 1024
#   bash run.sh qwen-2.5-7b-1m synthetic niah_single_1,niah_single_2 2048
#   bash run.sh qwen-2.5-7b-1m synthetic all 4096
...
ROOT_DIR="recall_test" # the path that stores generated task samples and model predictions.
...
PQ_COMPRESSOR="pq_search"  # Compression method: pq_search, sparq_f, infllm, h2o, original
PQ_N_SUBVEC=4         # Number of PQ subvectors per head
PQ_N_SUBBITS=8       # Bits per PQ subvector
...
PQ_FIXTHRESHOLD=0.85 # Fixed threshold for topp attention

# System parameters
DEVICE=0              # GPU device ID
MAX_CPU_IN_USE=32    # Number of CPU cores for K-means
