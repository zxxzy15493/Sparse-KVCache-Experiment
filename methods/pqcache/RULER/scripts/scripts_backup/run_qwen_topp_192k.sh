...
PQ_BUDGET=2048         # Fixed budget size
...
PQ_RECENT_SIZE=0     # Number of recent tokens to keep
PQ_SINK_SIZE=0       # Number of most recent tokens to always keep
PQ_COMPRESSOR="no_drop_lb_topp"  # Compression method: pq_search, sparq_f, infllm, h2o, original
