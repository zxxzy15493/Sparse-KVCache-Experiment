    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.compressor == "original":
            ...
            # TODO: can decoding here use varlen_func for speedup?
            ...
            if first_time:
                ...
                # print(f"prefill time {end - begin }, layer id {self.layer_idx}")
            else:
                # begin = time.perf_counter()
                key_states = repeat_kv(key_states, self.num_key_value_groups) 
                value_states = repeat_kv(value_states, self.num_key_value_groups)
                ...
                # end = time.perf_counter()
                # print(f"decode time {end - begin }, layer id {self.layer_idx}")
        else: 
