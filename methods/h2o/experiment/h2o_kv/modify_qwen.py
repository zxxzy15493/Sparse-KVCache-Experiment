...
def qwen_attention_forward(
    ...
    **kwargs,
    ...
    if past_key_value is not None:
        ...
        key_states_compress, value_states_compress = self.kv_cache.evict_for_space(query_states, key_states,value_states)
...
def enable_qwen_pos_shift_attention(model):
    ...
    for name, module in model.named_modules():
        if isinstance(module, (Qwen2Attention, Qwen2SdpaAttention, Qwen2FlashAttention2)):
            module.forward = types.MethodType(qwen_attention_forward, module)
