...
#include "km_include/decode_attn.cuh"
...
BatchDecodeWithPagedKVCacheWrapper(BatchDecodeHandler* handler,
	...
	paged_kv_t<page_storage, kv_layout, DTypeIn, IdType, full> new_paged_kv = paged_kv;
	...
	return BatchDecodeWithPagedKVCache<page_storage, kv_layout, DTypeIn, DTypeOut, IdType, full>(
		q,
		new_paged_kv,
		kv_partition_info,
		o,
