...
python eval/evaluate.py \
    --data_dir  benchmark_root/llama3.1-8b/synthetic/4096/pred\
    --benchmark synthetic
```
"""
...
def read_manifest(manifest_path: str) -> List[Dict]:
    """
    Reads a NeMo-style manifest file (JSON Lines).
...
def write_manifest(
    ...
    """
    Writes data to a NeMo-style manifest file (JSON Lines).
    """
