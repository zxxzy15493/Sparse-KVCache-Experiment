...
class QuestAttention(nn.Module):
    ...
    def forward(
        ...
        iController: Optional[clusterkv.utils.InferenceController] = None,
        ...
        if q_len > 1:
            ...
            attn_output = clusterkv.utils.prefill_forward(
                query_states,
                iController,
                self.layer_idx,
            )
            ...
            if iController.need_estimate() == False:
                ...
                attn_output = clusterkv.utils.decode_sparse_attn(
                    query_states,
                    iController,
                    self.layer_idx,
                ...
                estimated_attn_score = clusterkv.utils.decode_estimate(
                    query_states,
                    iController,
                    self.layer_idx,
                )
