# Based on HuggingFace Llama Model: transformers/models/llama/modeling_llama.py
# Updated to use modeling_llama classes while preserving ClusterKV functionality
...
from transformers.models.llama.modeling_llama import (
    ...
    LlamaPreTrainedModel as LlamaPreTrainedModelBase,
    rotate_half,
...
# )
# class LlamaPreTrainedModel(LlamaPreTrainedModelBase):
#     """Using imported LlamaPreTrainedModel from modeling_llama"""
#     pass
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        # KV-Cache is managed by Controller
        if position_ids is None:
            device = input_ids.device if input_ids is not None else inputs_embeds.device
            past_key_values_length = self.controller.kv_seqlen
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def clusterkv_init(
        ...
        """
        # assert self.model.controller is None, "Can't init ClusterKV Controller twice."
