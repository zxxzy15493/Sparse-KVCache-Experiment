...
PRED_DIR="./results/efficencyOverview/${MODEL}/${MODE}/${INPUT_MAX_TOKEN}_${fixed_output_length}/${except_budget}"
LOG_DIR="./log/efficencyOverview/${MODEL}/${MODE}/${INPUT_MAX_TOKEN}_${fixed_output_length}/"
mkdir -p ${PRED_DIR}
mkdir -p ${LOG_DIR}
