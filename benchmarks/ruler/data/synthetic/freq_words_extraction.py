...
parser.add_argument("--tokenizer_type", type=str, default='hf', help='Only hf is supported.')
...
parser.add_argument("--model_template_token", type=int, default=0, help='number of model-template tokens to exclude')
